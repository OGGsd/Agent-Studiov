...
from axie_studio.base.vectorstores.utils import chroma_collection_to_data
from axie_studio.inputs.inputs import MultilineInput
from axie_studio.io import BoolInput, DropdownInput, HandleInput, IntInput, MessageTextInput, TabInput
...
class LocalDBComponent(LCVectorStoreComponent):
    ...
    def get_default_persist_dir(self) -> str:
        ...
        from axie_studio.services.cache.utils import CACHE_DIR
