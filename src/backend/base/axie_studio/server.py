...
from axie_studio.logging.logger import InterceptHandler


class AxieStudioUvicornWorker(UvicornWorker):
...
class AxieStudioApplication(BaseApplication):
    def __init__(self, app, options=None) -> None:
        self.options = options or {}

        self.options["worker_class"] = "axie_studio.server.AxieStudioUvicornWorker"
