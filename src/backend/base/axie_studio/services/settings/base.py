...
from axie_studio.serialization.constants import MAX_ITEMS_LENGTH, MAX_TEXT_LENGTH
from axie_studio.services.settings.constants import VARIABLES_TO_GET_FROM_ENVIRONMENT
from axie_studio.utils.util_strings import is_valid_database_url
...
class Settings(BaseSettings):
    ...
    store: bool | None = False  # Disabled for production security
    store_url: str | None = None  # Remove external store dependency
    download_webhook_url: str | None = None  # Remove external webhooks
    like_webhook_url: str | None = None  # Remove external webhooks
    ...
    def set_dev(cls, value):
        from axie_studio.settings import set_dev
