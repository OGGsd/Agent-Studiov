...
from axie_studio.services.schema import ServiceType
...
if TYPE_CHECKING:
    ...
    from axie_studio.services.cache.service import AsyncBaseCacheService, CacheService
    ...
    from axie_studio.services.state.service import StateService
    ...
    from axie_studio.services.variable.service import VariableService
...
def get_service(service_type: ServiceType, default=None):
    ...
    """
    from axie_studio.services.manager import service_manager
...
def get_telemetry_service() -> TelemetryService:
    ...
    """
    from axie_studio.services.telemetry.factory import TelemetryServiceFactory
...
def get_tracing_service() -> TracingService:
    ...
    """
    from axie_studio.services.tracing.factory import TracingServiceFactory
...
def get_state_service() -> StateService:
    ...
    """
    from axie_studio.services.state.factory import StateServiceFactory
...
def get_storage_service() -> StorageService:
    ...
    """
    from axie_studio.services.storage.factory import StorageServiceFactory
...
def get_variable_service() -> VariableService:
    ...
    """
    from axie_studio.services.variable.factory import VariableServiceFactory
...
def get_settings_service() -> SettingsService:
    ...
    """
    from axie_studio.services.settings.factory import SettingsServiceFactory
...
def get_db_service() -> DatabaseService:
    ...
    """
    from axie_studio.services.database.factory import DatabaseServiceFactory
...
def get_cache_service() -> CacheService | AsyncBaseCacheService:
    ...
    """
    from axie_studio.services.cache.factory import CacheServiceFactory
...
def get_shared_component_cache_service() -> CacheService:
    ...
    Returns:
        The cache service instance.
    """
    from axie_studio.services.shared_component_cache.factory import SharedComponentCacheServiceFactory
...
def get_session_service() -> SessionService:
    ...
    """
    from axie_studio.services.session.factory import SessionServiceFactory
...
def get_task_service() -> TaskService:
    ...
    """
    from axie_studio.services.task.factory import TaskServiceFactory
...
def get_queue_service() -> JobQueueService:
    ...
    from axie_studio.services.job_queue.factory import JobQueueServiceFactory
