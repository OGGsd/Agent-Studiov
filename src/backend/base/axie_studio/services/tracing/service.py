...
if TYPE_CHECKING:
    ...
    from axie_studio.services.tracing.base import BaseTracer
    from axie_studio.services.tracing.schema import Log


def _get_langsmith_tracer():
    from axie_studio.services.tracing.langsmith import LangSmithTracer

    return LangSmithTracer


def _get_langwatch_tracer():
    from axie_studio.services.tracing.langwatch import LangWatchTracer

    return LangWatchTracer


def _get_langfuse_tracer():
    from axie_studio.services.tracing.langfuse import LangFuseTracer

    return LangFuseTracer


def _get_arize_phoenix_tracer():
    from axie_studio.services.tracing.arize_phoenix import ArizePhoenixTracer

    return ArizePhoenixTracer


def _get_opik_tracer():
    from axie_studio.services.tracing.opik import OpikTracer
