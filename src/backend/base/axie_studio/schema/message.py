...
from axie_studio.base.prompts.utils import dict_values_to_string
from axie_studio.schema.content_block import ContentBlock
from axie_studio.schema.content_types import ErrorContent
from axie_studio.schema.data import Data
from axie_studio.schema.image import Image, get_file_paths, is_image_file
from axie_studio.schema.properties import Properties, Source
from axie_studio.schema.validators import timestamp_to_str, timestamp_to_str_validator
from axie_studio.utils.constants import (
    MESSAGE_SENDER_AI,
    MESSAGE_SENDER_NAME_AI,
    MESSAGE_SENDER_NAME_USER,
    MESSAGE_SENDER_USER,
)
from axie_studio.utils.image import create_image_content_dict
...
class Message(Data):
    ...
    def to_dataframe(self) -> DataFrame:
        from axie_studio.schema.dataframe import DataFrame  # Local import to avoid circular import
