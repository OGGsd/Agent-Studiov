...
from axie_studio.utils.constants import MESSAGE_SENDER_AI, MESSAGE_SENDER_USER
...
class Data(BaseModel):
    ...
    def to_lc_message(
        ...
        if sender == MESSAGE_SENDER_USER:
            if files:
                from axie_studio.schema.image import get_file_paths
    ...
    def filter_data(self, filter_str: str) -> Data:
        ...
        """
        from axie_studio.template.utils import apply_json_filter

        return apply_json_filter(self.data, filter_str)

    def to_message(self) -> Message:
        from axie_studio.schema.message import Message  # Local import to avoid circular import
