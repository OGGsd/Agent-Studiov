...
from axie_studio.exceptions.component import ComponentBuildError
from axie_studio.graph.edge.base import CycleEdge, Edge
from axie_studio.graph.graph.constants import Finish, lazy_load_vertex_dict
from axie_studio.graph.graph.runnable_vertices_manager import RunnableVerticesManager
from axie_studio.graph.graph.schema import GraphData, GraphDump, StartConfigDict, VertexBuildResult
from axie_studio.graph.graph.state_model import create_state_model_from_graph
from axie_studio.graph.graph.utils import (
...
from axie_studio.graph.schema import InterfaceComponentTypes, RunOutputs
from axie_studio.graph.utils import log_vertex_build
from axie_studio.graph.vertex.base import Vertex, VertexStates
from axie_studio.graph.vertex.schema import NodeData, NodeTypeEnum
from axie_studio.graph.vertex.vertex_types import ComponentVertex, InterfaceVertex, StateVertex
from axie_studio.logging.logger import LogConfig, configure
from axie_studio.schema.dotdict import dotdict
from axie_studio.schema.schema import INPUT_FIELD_NAME, InputType, OutputValue
from axie_studio.services.cache.utils import CacheMiss
from axie_studio.services.deps import get_chat_service, get_tracing_service
from axie_studio.utils.async_helpers import run_until_complete

if TYPE_CHECKING:
    from collections.abc import Callable, Generator, Iterable

    from axie_studio.api.v1.schemas import InputValueRequest
    ...
    from axie_studio.services.chat.schema import GetCache, SetCache
...
class Graph:
    ...
    async def _log_vertex_build_from_exception(self, vertex_id: str, result: Exception) -> None:
        ...
        if isinstance(result, ComponentBuildError):
            ...
            from axie_studio.api.utils import format_exception_message
