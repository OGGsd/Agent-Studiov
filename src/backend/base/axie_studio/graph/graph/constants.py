...
from axie_studio.graph.schema import CHAT_COMPONENTS
from axie_studio.utils.lazy_load import LazyLoadDictBase

if TYPE_CHECKING:
    from axie_studio.graph.vertex.base import Vertex
    from axie_studio.graph.vertex.vertex_types import CustomComponentVertex
...
def _import_vertex_types():
    from axie_studio.graph.vertex import vertex_types
