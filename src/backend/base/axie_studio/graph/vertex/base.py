...
from axie_studio.graph.schema import INPUT_COMPONENTS, OUTPUT_COMPONENTS, InterfaceComponentTypes, ResultData
from axie_studio.graph.utils import UnbuiltObject, UnbuiltResult, log_transaction
from axie_studio.graph.vertex.param_handler import ParameterHandler
from axie_studio.interface import initialize
from axie_studio.interface.listing import lazy_load_dict
from axie_studio.schema.artifact import ArtifactType
from axie_studio.schema.data import Data
from axie_studio.schema.message import Message
from axie_studio.schema.schema import INPUT_FIELD_NAME, OutputValue, build_output_logs
from axie_studio.services.deps import get_storage_service
from axie_studio.utils.schemas import ChatOutputResponse
from axie_studio.utils.util import sync_to_async
...
class Vertex:
    ...
    async def build(
        ...
        **kwargs,
        ...
        from axie_studio.interface.components import ensure_component_loaded
