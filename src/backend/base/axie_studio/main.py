...
from axie_studio.api import health_check_router, log_router, router
from axie_studio.api.v1.mcp_projects import init_mcp_servers
from axie_studio.initial_setup.setup import (
...
from axie_studio.interface.utils import setup_llm_caching
from axie_studio.logging.logger import configure
from axie_studio.middleware import ContentSizeLimitMiddleware
from axie_studio.services.deps import (
    get_queue_service,
    get_settings_service,
    get_telemetry_service,
)
from axie_studio.services.utils import initialize_services, teardown_services
...
def create_app():
    ...
    if settings.mcp_server_enabled:
        from axie_studio.api.v1 import mcp_router
