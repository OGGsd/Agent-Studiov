...
from axie_studio.base.tools.constants import (
    TOOL_OUTPUT_DISPLAY_NAME,
    TOOL_OUTPUT_NAME,
    TOOLS_METADATA_INFO,
    TOOLS_METADATA_INPUT_NAME,
)
from axie_studio.custom.tree_visitor import RequiredInputsVisitor
from axie_studio.exceptions.component import StreamingError
from axie_studio.field_typing import Tool  # noqa: TC001 Needed by _add_toolkit_output

# Lazy import to avoid circular dependency
# from axie_studio.graph.state.model import create_state_model
# Lazy import to avoid circular dependency
# from axie_studio.graph.utils import has_chat_output
from axie_studio.helpers.custom import format_type
from axie_studio.memory import astore_message, aupdate_messages, delete_message
from axie_studio.schema.artifact import get_artifact_type, post_process_raw
from axie_studio.schema.data import Data
from axie_studio.schema.message import ErrorMessage, Message
from axie_studio.schema.properties import Source
from axie_studio.services.tracing.schema import Log
from axie_studio.template.field.base import UNDEFINED, Input, Output
from axie_studio.template.frontend_node.custom_components import ComponentFrontendNode
from axie_studio.utils.async_helpers import run_until_complete
from axie_studio.utils.util import find_closest_match
...
if TYPE_CHECKING:
    ...
    from axie_studio.base.tools.component_tool import ComponentToolkit
...
class Component(CustomComponent):
    ...
    async def _build_tools_metadata_input(self):
        try:
            from axie_studio.io import ToolsInput
        except ImportError as e:
            msg = "Failed to import ToolsInput from axie_studio.io"
