...
from axie_studio.custom.directory_reader.utils import (
    abuild_custom_component_list_from_path,
    build_custom_component_list_from_path,
    merge_nested_dicts_with_renaming,
)
from axie_studio.custom.eval import eval_custom_component_code
from axie_studio.custom.schema import MissingDefault
...
from axie_studio.template.frontend_node.custom_components import ComponentFrontendNode, CustomComponentFrontendNode
from axie_studio.type_extraction.type_extraction import extract_inner_type
from axie_studio.utils import validate
from axie_studio.utils.util import get_base_classes
...
async def load_custom_component(component_name: str, components_paths: list[str]):
    ...
    """
    from axie_studio.interface.custom_component import get_custom_component_from_name
